        ...
        <section className="emprestimos">
            <div className="emprestimos-acoes">
                ...
                <ToastContainer
                    ...
                    style={{zIndex: 10}}
                >
                    <Toast bg="success" onClose={() => setShowToastSuccess(false)} show={showToastSuccess} delay={3000}
                           autohide>
                        <Toast.Header>
                ...
                <ToastContainer
                    ...
                    style={{zIndex: 10}}
                >
                    <Toast bg="danger" onClose={() => setShowToastError(false)} show={showToastError} delay={3000}
                           autohide>
                        <Toast.Header>
